...
$history_id = (empty($_POST['ishistory'])) ? sanitize_text_field(isset($_GET['id']) ? $_GET['id'] : 0) : sanitize_text_field($_POST['ishistory']);
...
<p>
	<a href="<?php echo $src; ?>" id="newwindowbutton" <?php if (empty($history_id)) : ?>disabled="disabled"<?php endif; ?> target="_blank" class="button button-secondary"><i class="fa fa-external-link"></i> <?php esc_html_e('Open in New Window', 'wp-mailinglist'); ?></a>
	<a href="" id="previewrunnerbutton" onclick="newsletters_autosave(); return false;" class="button button-primary"><i class="fa fa-eye"></i> <?php esc_html_e('Update Preview', 'wp-mailinglist'); ?></a>
