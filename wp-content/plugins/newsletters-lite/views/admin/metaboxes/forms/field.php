		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<?php else : ?>
						<input type="text" class="widefat" name="form_fields[<?php echo esc_html( $field -> id); ?>][placeholder]" id="form_fields_<?php echo esc_html( $field -> id); ?>_placeholder" value="<?php echo esc_attr(wp_unslash(esc_html($form_field -> placeholder))); ?>" placeholder="<?php echo esc_attr(wp_unslash(esc_html($field -> watermark))); ?>" />
					<?php endif; ?>
					<span class="howto"><?php esc_html_e('Placeholder/watermark to show inside this field when it is empty/blank.', 'wp-mailinglist'); ?></span>
				</td>
			</tr>
			<tr>
