...
<div id="tribulant_content_full">
	<div id="tribulant_content">
		<h1>WordPress Newsletter plugin - Changelog</h1>		
		<?php if (!empty($changelog)) : ?>
			<?php echo wp_kses_post( wp_unslash($changelog)) ?>
		<?php else : ?>
			<?php esc_html_e('No changelog is available for this release yet, please check back later.', 'wp-mailinglist'); ?>
		<?php endif; ?>
	</div>
</div>
...
<style type="text/css">
	*, html, body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, form, label, fieldset, input, p, blockquote, th, td{margin:0;padding:0}
	...
	#tribulant_logo { background:url('<?php echo esc_url_raw( $this -> render_url('images/changelog-logo.png', 'admin', false)); ?>') no-repeat; text-indent:-9999px; width:251px; height:59px; display:block; }
