...
require_once(dirname(__FILE__) . DS . 'html2textexception.php');
...
class Html2Text {
	...
	public static function convert($html, $ignore_error = false) {
		...
		if (function_exists('mb_detect_encoding') && function_exists('mb_convert_encoding') && mb_detect_encoding($html, "UTF-8", true)) {
